...
\title{Human centric program comprehension using hierarchical abstractions of software systems}
...
% ABSTRACT
\abstract{
New contributors to open source projects struggle to comprehend a software system due to lack of domain knowledge, proper documentation which hinders nourishment of open source projects. Similarly, new members of a software team can struggle if proper software engineering principals are not practiced in the team. Reading through code, finding the relevant class, files take a significant portion of time from the time required to perform a specific task. Having good tool support for this code browsing activity can reduce a lot of human effort and increase overall developer productivity. To help program comprehension models, research on building hierarchical abstraction of a software system from call graph is going on. As call graph can be difficult to comprehend for a larger code-base, the idea is to find execution scenarios and cluster them together by concentrating the information in the code-base. Later, different techniques are applied to label nodes in the cluster tree. In this thesis, we focus on static call graphs for creating hierarchical abstraction as it captures all the possible program scenarios. First, to advance existing work we introduced new information retrieval techniques alongside human involved evaluation. Second, from our observation we introduced two type of information to abstraction nodes for better understanding of the nodes. Finally, we introduced an interactive software system which can be used to browse the code-base in guided way by targeting specific unit of the source code.     
...
I dedicate this thesis to my mother Bina Bhattacharjee, my father Arun Kumar Bhattacharjee and my younger brother Bishwajit Bhattacharjee, who always believed in my ability and inspired me to become the best version of myself.
}
