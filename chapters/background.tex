...
Explain the concept cluster tree, with the role of leaf node, intermediate nodes for example. % create a similar figure to CCT but bring the summary, pattern part. May be try to use the previous call graph info to generate the tree and explain well so that anyone can understand
